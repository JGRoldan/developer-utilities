...
- [Button Hover Examples](https://blog.avada.io/css/button-hover-effects)
- [Smooth Shadow Generator](https://shadows.brumm.af/)
- [Free tools | Getcssscan](https://getcssscan.com/)
...
### API
- [Hoppscotch | Test your API requests online](https://hoppscotch.io/)
